...
let user, choice, msg, price, emailID;
...
async function main() {
    try {
        ...
        if (choice === 'createMsg') {
            await contract.submitTransaction('createMsg', msg, price, emailID);
            console.log(`${choice} Transaction has been submitted`);
        } else if (choice === 'proposeMsg') {
            await contract.submitTransaction('proposeMsg', msg, price);
            console.log(`${choice} Transaction has been submitted`);
